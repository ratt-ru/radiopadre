...
def plot(cmdargs):
	...
	ax1 = figure( sizing_mode = 'scale_width', **TOOLS)
	ax2 = figure( sizing_mode = 'scale_width', x_range=ax1.x_range, **TOOLS)
...
def plot_K_table(mytab=None, **kwargs):
	"""
	Function for plotting delay tables , extension '.K' 
	Gets desired arguments and passes them to plotted
	REQUIRED:
