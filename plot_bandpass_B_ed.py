...
ax1 = figure(plot_width=PLOT_WIDTH, plot_height=PLOT_HEIGHT, title="something", **TOOLS)
ax2 = figure(plot_width=PLOT_WIDTH, plot_height=PLOT_HEIGHT, x_range=ax1.x_range,title="something here", **TOOLS)
...
for ant in plotants:
	...
	if doplot == 'ap':
		...
		p2 = ax2.circle('x','y2',color=y2col,size=8, source=source, nonselection_color='#7D7D7D',nonselection_line_alpha=0.3)
		p2_err = errorbar(ax2, chans, y2, color=y2col)	
